...
<body>
    ...
    <iframe src="https://drive.google.com/file/d/<?=$_GET['v']?>/preview" webkitallowfullscreen allowfullscreen mozallowfullscreen msallowfullscreen scrolling="0" frameborder="0" width="100%" height="100%"></iframe>
